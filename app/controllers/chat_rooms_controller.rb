class ChatRoomsController < ApplicationController
  def create
    ...
    # params[:chat_room][:user1_id] , , params[:chat_room][:user1_id], params[:chat_room][:user2_id]).to_a.first
    chat_room = ChatRoom.between(params[:chat_room][:user1_id], params[:chat_room][:user2_id])
